...
const clean = () => del([config.build.tmp, config.build.dist]);

const style = () =>
  src(config.build.paths.style, {
...
const useref = () =>
  src(`${config.build.tmp}/${config.build.paths.page}`, {
